...
const projects = [
  {
    id: 1,
    title: "Rajpath Club",
    description: "Official mobile application for Rajpath Club Limited with membership management, dining reservations, sports booking, and event notifications.",
    image: "/projects/rajpath.jpg",
    tags: ["Flutter", "REST API", "Firebase", "BLoC"],
  ...
  {
    id: 2,
    title: "Glade One Golf Club",
    description: "Premium golf club management application for Glade One Golf Club members with tee time booking, event management, and member services.",
    image: "/projects/gladeone.jpg",
    tags: ["Flutter", "Firebase", "Payment Gateway", "Booking System"],
    stats: { stars: 0, downloads: "5K+" },
    links: { github: "https://github.com/dileepmca88", live: "https://play.google.com/store/apps/details?id=com.gladeonegolfclub" },
    featured: true,
  },
  {
    id: 3,
    title: "Karnavati Club",
    description: "Feature-rich club management application for Karnavati Club members with seamless booking, notifications, and facility management.",
    image: "/projects/karnavati.jpg",
    tags: ["Flutter", "Firebase", "Provider", "Charts"],
    stats: { stars: 0, downloads: "10K+" },
    links: { github: "https://github.com/dileepmca88", live: "https://play.google.com/store/apps/details?id=com.karnavaticlub" },
    featured: true,
  },
  {
    id: 4,
    ...
    image: "/projects/nsci.jpg",
    tags: ["Flutter", "Firebase", "REST API", "Push Notifications"],
    stats: { stars: 0, downloads: "25K+" },
  ...
  },
  {
    id: 5,
    title: "KBG Club",
    description: "Comprehensive club management app for KBG Club with membership features, facility bookings, event management, and member services.",
    image: "/projects/kbg.jpg",
    tags: ["Flutter", "SQLite", "REST API", "State Management"],
    stats: { stars: 0, downloads: "8K+" },
    links: { github: "https://github.com/dileepmca88", live: "https://play.google.com/store/apps/details?id=com.kbgclub" },
    featured: false,
  },
  {
    id: 6,
    ...
    image: "/projects/smarttown.jpg",
    tags: ["Kotlin", "Firebase", "MVVM", "Room"],
    stats: { stars: 0, downloads: "15K+" },
  ...
  },
  {
    ...
    image: "/projects/clubo7.jpg",
    tags: ["Flutter", "Kotlin", "Firebase", "Payment Gateway"],
    stats: { stars: 0, downloads: "12K+" },
  ...
  },
  {
    id: 8,
    title: "Smart India",
    description: "Ed-Tech application designed to enhance the learning journey with smart features, interactive content, and educational resources.",
    image: "/projects/smartindia.jpg",
    tags: ["Flutter", "REST API", "Google Maps", "Push Notifications"],
    stats: { stars: 0, downloads: "50K+" },
    links: { github: "https://github.com/dileepmca88", live: "https://play.google.com/store/apps/details?id=com.voiceofthings.smartindia" },
    featured: false,
  },
  {
    id: 9,
    title: "AppWriter App",
    description: "Educational writing application designed to help students improve their writing skills with interactive exercises and feedback.",
    image: "/projects/appwriter.jpg",
    tags: ["Flutter", "Educational", "Interactive UI", "Learning"],
    stats: { stars: 0, downloads: "20K+" },
    links: { github: "https://github.com/dileepmca88", live: "https://play.google.com/store/apps/details?id=com.wizkids.appwriter" },
    featured: false,
  },
  {
    id: 10,
    title: "My DDD",
    description: "Personal productivity and daily task management application with features for tracking daily activities and managing schedules.",
    image: "/projects/myddd.jpg",
    tags: ["Flutter", "Productivity", "Task Management", "Local Storage"],
    stats: { stars: 0, downloads: "5K+" },
    links: { github: "https://github.com/dileepmca88", live: "https://play.google.com/store/apps/details?id=com.my.ddd" },
    featured: false,
  },
]
